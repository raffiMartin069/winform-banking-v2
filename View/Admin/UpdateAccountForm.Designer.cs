namespace Martinez_Bank.View.Admin
{
	partial class UpdateAccountForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.label5.Size = new System.Drawing.Size(442, 25);
			this.label5.TabIndex = 1;
			this.label5.Text = "A few quick updates can improve client experience.";
			// 
			// label12
			// 
			...
			this.label12.Text = "Keeping client details current.";
			// 
			// tableLayoutPanel2
			// 
